...
libero, a feugiat eros. Nunc ut lacinia tortors." />
                ...
                <section className="author-area padding-top-100px padding-bottom-100px">
                    <div className="container-fluid">
                        <div className="row section-title-width text-center">
                            <SectionsHeading title="Meet Top Authors" titleClass="text-white" desc="Top 700+ famous authors on the enStock. consectetur adipisicing elit Adipisci culpa possimus quis  voluptatibus!" />
                        </div>
