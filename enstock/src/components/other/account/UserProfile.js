    ...
    render() {
        return (
            <main className="user-profile">
                ...
                {/* Breadcrumb */}
                <Breadcrumb CurrentPgTitle="User Profile" MenuPgTitle="Paginas"  img={this.states.BreadcrumbImg} />
                    ...
                    <div className="container">
                        <div className="row">
                            ...
                            <div className="col-lg-8">
                                <h3 className="widget-title">Listas</h3>
                                ...
                                <div className="row">
                                    <div className="col-lg-12">
                                        <div className="button-shared text-center">
                                            <Button text="ver mas listing" url="#" className="border-0">
