                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-12">
                                    <div className="input-box">
                                        <label className="label-text">Username o email</label>
                                        <div className="form-group">
                                                <span className="form-icon">
                                                    <AiOutlineUser />
                                                </span>
                                            <input className="form-control" type="email" name="text" placeholder="Username o email" />
                                        </div>
                                    </div>
                                </div>
                                <div className="col-lg-12">
                                    ...
                                    <div className="form-group">
                                        <div className="custom-checkbox mr-0 d-flex align-items-center justify-content-between">
                                            <div>
                                                ...
                                                <label htmlFor="chb1">Recuerdame</label>
                                            </div>
                                            <div>
                                ...
                                <div className="col-lg-12">
                                    <p className="font-weight-medium">¿No tiene una cuenta? <Link to="/sign-up" className="color-text"> Registrese</Link></p>
                                </div>
                            </div>
                        </form>
                    </div>
