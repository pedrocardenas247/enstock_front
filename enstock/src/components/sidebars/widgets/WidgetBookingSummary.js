                ...
                <div className="billing-content">
                    <div className="booking-summary">
                        <ul className="booking-list">
                            {date ? (
                                <li className="d-flex align-items-center justify-content-between">SubTotal: <span>{date}</span></li>
                            ) : ''}
                            {hour ? (
                                <li className="d-flex align-items-center justify-content-between">Costo de Envio: <span>{hour}</span></li>
                            ) : ''}
                            {adults ? (
                                <li className="d-flex align-items-center justify-content-between">Metodo de Pago: <span>{adults}</span></li>
                            ) : ''}
                            {/* {children ? (
                                        ...
                                        <div className="col-lg-8 pr-0">
                                            <div className="input-box">
                                                <div className="form-group mb-0">
                                                    ...
                                                    <input className="form-control" type="text" name="name" placeholder="Si tiene un Cupon ingreselo aqui" />
                                                </div>
                                            </div>
                                        </div>
